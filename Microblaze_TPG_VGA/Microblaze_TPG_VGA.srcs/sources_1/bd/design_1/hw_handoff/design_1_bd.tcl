...
proc create_root_design { parentCell } {
  ...
  set gen_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 gen_1 ]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_ports Hsync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_ports Vsync] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs v_tpg_0/s_axi_CTRL/Reg] -force
